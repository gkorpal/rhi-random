...
The [`polz`](/polz-random/) directory contains the code and data about such polarizations for primes of interest. 
...
The [`deg`](/polz-random/deg/) directory contains the code and data about degree maps and $\max(\min(\deg))$ values for the primes of interest for random polarizations.
...
The [`aut`](/polz-random/aut/) directory contains the code and data about the automorphism group distribution for the primes of interest.
...
The [`polz-exact`](./polz-exact/) directory contains code and data about polarizations and corresponding refined Humbert invariants.
...
The [`genus5`](/genus5/) and [`genus5via4`](/genus5via4/) directories contain the code and data about the genus of this 5-ary form for primes of interest.
